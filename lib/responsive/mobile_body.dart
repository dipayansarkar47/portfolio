                    ...
                    child: Column(
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            Lottie.network(
                                'https://assets10.lottiefiles.com/packages/lf20_ywt06tjx.json',
                                height: 50,
                                width: 50),
                            Lottie.network(
                                'https://assets1.lottiefiles.com/packages/lf20_vnqzcze6.json',
                                height: 50,
                                width: 50),
                            Lottie.network(
                                'https://assets2.lottiefiles.com/private_files/lf30_bbx4oauz.json',
                                height: 50,
                                width: 50),
                          ],
                        ),
                        Lottie.network(
                            'https://assets8.lottiefiles.com/packages/lf20_u0sqq9uw.json',
                            height: 200,
                            width: 200),
                        SizedBox(
                          height: 10,
